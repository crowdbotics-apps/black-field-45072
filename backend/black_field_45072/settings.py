"""
Django settings for black_field_45072 project.
...
ROOT_URLCONF = 'black_field_45072.urls'
...
WSGI_APPLICATION = 'black_field_45072.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_field_45072 API",
    "DESCRIPTION": "API documentation for black_field_45072 App",
    "VERSION": "v1",
}
